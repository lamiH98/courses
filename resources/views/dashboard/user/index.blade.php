            ...
            <table class="table table-striped- table-bordered table-hover table-checkable" id="example">
                <thead>
                    <tr>
                        ...
                        <th>@lang('user.index.type')</th>
                        <th>@lang('user.index.stage')</th>
                        <th>@lang('user.index.points')</th>
                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td>{{ $user->email }}</td>
                            <td>{{ $user->type }}</td>
                            <td>{{ $user->stage->stage }}</td>
                            <td>{{ $user->points }}</td>
                            <td><a href="{{ route('user.courses', $user->id) }}">{{ count($user->courses) }}</a></td>
