...
@section('subtitle')
    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
        ...
        <li class="m-nav__item"><a href="{{ route('video.index') }}" class="m-nav__link"><span class="m-nav__link-text">@lang('video.create.videos')</span></a></li>
        <li class="m-nav__separator">-</li>
                        ...
                        <div class="m-form__actions m-form__actions">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <a href="{{ route('video.index') }}" class="btn btn-secondary">@lang('video.create.back')</a>
                                </div>
                            </div>
                        </div>
                    </div>
